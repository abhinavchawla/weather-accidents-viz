...
def get_state_time(time_range,state=''):
    ...
    month_dic={'January':0,'February':0,'March':0,'April':0,'May':0,'June':0,'July':0,'August':0,'September':0,'October':0,'November':0,'December':0}
...
def get_pcp_data():
    attributes=['Severity','Temperature(F)','Humidity(%)','Visibility(mi)', 'Weather_Condition','Sunrise_Sunset', 'Traffic_Signal', 'Junction','Wind_Speed(mph)']
